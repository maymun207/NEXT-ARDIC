          ...
          {SUB_SERVICES.map((sub, i) => {
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: isHovered 
                    ...
                    : "0 8px 16px rgba(0,0,0,0.02), 0 0 0 1px rgba(0,0,0,0.04)",
              ...
              >
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "1.25rem" }}>
                  ...
                  <Link
                    ...
                    style={{
                      ...
                      fontSize: "10.5px", fontWeight: 800, letterSpacing: "0.12em", textDecoration: "none",
                      transition: "all 0.4s ease",
                ...
                <h3 style={{
                  fontSize: "1.3rem", fontWeight: 700, color: "#050505", fontFamily: "'DM Serif Display', serif",
                ...
                <p style={{
                  color: sub.accent, fontSize: "12px", fontWeight: 700, letterSpacing: "0.05em",
                ...
                <div style={{
                  ...
                  <div style={{ overflow: "hidden" }}>
                    <p style={{ color: "rgba(0,0,0,0.65)", fontSize: "13px", lineHeight: 1.5, marginBottom: "1.25rem" }}>
                      {sub.description}
                    </p>
                    <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.6rem" }}>
                      {sub.bullets.map((b, bi) => (
                        <li key={bi} style={{ display: "flex", alignItems: "flex-start", gap: "0.75rem" }}>
                          ...
                          <span style={{ color: "rgba(0,0,0,0.75)", fontSize: "12px", lineHeight: 1.4, fontWeight: 500 }}>{b}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
